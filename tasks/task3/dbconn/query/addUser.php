<?php
    ...
    $sql_insert = $conn->prepare("INSERT INTO users (fname, lname, birthdate, personalnumber, regdate, position, image)
                                        VALUES (:firstname, :lastname, :birthdate, :personalnumber, :regdate, :position, :image)");
